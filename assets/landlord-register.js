(function(){
 ...
 function applicationForm(){
  ...
  bindSignout();const f=document.getElementById('landlordApplication');f.onsubmit=async e=>{
   ...
   const data={full_name:value('laName'),phone,business_type:value('laType'),company:value('laCompany'),region:value('laRegion'),city:IvaGeo.city(value('laCity')),inventory_count:Number(value('laCount')),website,comment:value('laComment'),categories:selected,accept_terms:document.getElementById('laTerms').checked,accept_privacy:document.getElementById('laPrivacy').checked};
